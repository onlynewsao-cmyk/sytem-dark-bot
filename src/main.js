...
╠══════════════════════════════════════════════════════════╣
║  📱 Número: +${pairingNumber.padEnd(44)}║
║                                                          ║
║  ⚠️ ATENÇÃO: NÃO AGUARDE NOTIFICAÇÃO CHEGAR!             ║
║  Muitas vezes o WhatsApp NÃO envia notificação na tela.  ║
║                                                          ║
║  👉 SIGA ESTES PASSOS NO SEU CELULAR AGORA:              ║
║  1. Abra o WhatsApp no celular                           ║
║  2. Toque nos 3 pontinhos (ou Configurações)             ║
║  3. Toque em "Aparelhos conectados"                      ║
║  4. Toque no botão verde "Conectar um aparelho"          ║
║  5. Na tela da câmera, toque embaixo em:                 ║
║     "Conectar com número de telefone"                    ║
║  6. Digite exatamente o código acima                     ║
║                                                          ║
║  ⏰ Válido por 60s. Renovando se necessário...           ║
╚══════════════════════════════════════════════════════════╝
`);
